    ...
    return (
      <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg transition-colors">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <FormInput id="name" type="text" label="Your Name" placeholder="John Doe" />
          ...
          <p className="text-sm text-center font-light text-gray-500 dark:text-gray-400">
            ...
            <a href="#" onClick={() => setView('userLogin')} className="font-medium text-blue-600 hover:underline dark:text-blue-500">
              Login here
            </a>
          </p>
          <p className="text-sm text-center font-light text-gray-500 dark:text-gray-400">
            Are you a Food Partner?{' '}
            <a href="#" onClick={() => setView('partnerRegister')} className="font-medium text-green-600 hover:underline dark:text-green-500">
              Register here
            </a>
          </p>
        </form>
